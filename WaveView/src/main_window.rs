...
impl MainWindow {
    pub fn make_window() -> Self {
        ...
        // Output widget
        let ww = WaveWidget::new(MARGIN, MARGIN,
            WAVE_VIEW_SIZE, WAVE_VIEW_SIZE);
        ...
        let mut h_in = valuator::ValueSlider::default()
            .with_size(125, 25)
            .below_of(&g_in, 5)
            .with_label("h =").with_align(enums::Align::Left);
        ...
        let mut delta_in = valuator::ValueSlider::default()
            .with_size(125, 25)
            .below_of(&h_in, 5)
            .with_label("delta =").with_align(enums::Align::Left);
        ...
        let mut eps_in = valuator::ValueSlider::default()
            .with_size(125, 25)
            .below_of(&delta_in, 5)
            .with_label("eps =").with_align(enums::Align::Left);
        ...
        let mut btn_apply = button::Button::default()
            .with_size(90, 25)
            .below_of(&dtime_in, 10).center_x(&g_params)
            .with_label("Apply");
